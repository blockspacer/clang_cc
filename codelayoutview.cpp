    ...
    m_TUManager(tm)
{
	...
	//Setup events
	m_TUManager.Connect(ccEVT_PARSE_END, ccEventHandler(CodeLayoutView::OnParseEnd), nullptr, this);
    m_TUManager.Connect(ccEVT_REPARSE_END, ccEventHandler(CodeLayoutView::OnParseEnd), nullptr, this);
}
