...
OptionsPanel::OptionsPanel(wxWindow* parent)
{
    ...
    XRCCTRL(*this, "rb_string_filter_type", wxRadioBox)->SetSelection(cfg->ReadInt(_T("/string_filter_type"), 0));
...
void OptionsPanel::OnApply()
{
    ...
    //Code Complete Popup Options
    cfg->Write(_T("/string_filter_type"), XRCCTRL(*this, "rb_string_filter_type", wxRadioBox)->GetSelection());
    //Translation Unit Options
